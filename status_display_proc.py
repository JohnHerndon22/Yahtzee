...
def main_window():
    ...
    counter = 1
    layout = [[sg.Text('<<< Yahtzee >>>', size=(30, 1), justification='left', font=("Helvetica", 25), relief=sg.RELIEF_RIDGE)],[sg.Text('espnid: ' + str(counter), key='output')]]
